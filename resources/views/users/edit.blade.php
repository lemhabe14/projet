...
<div class="card p-4 shadow-sm" style="max-width: 600px;">
    ...
    <form method="POST" action="{{ route('users.update', $utilisateur) }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="nom" class="form-control" value="{{ old('nom', $utilisateur->nom) }}">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="email" name="email" class="form-control" value="{{ old('email', $utilisateur->email) }}">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="adresse" class="form-control" value="{{ old('adresse', $utilisateur->adresse) }}">
        </div>
